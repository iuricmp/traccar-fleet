...
class PersonGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Person entity")
        ...
        .repeat(2) {
            ...
            .post("/api/people")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "personType":null, "federalId":"SAMPLE_TEXT", "name":"SAMPLE_TEXT", "tradeName":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "alfaId":"SAMPLE_TEXT", "externalId":null}""")).asJSON
            .check(status.is(201))
